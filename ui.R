  ...
  'Ott Toomet\'s Fan Club Presents: Bob Ross',
    ...
    tabPanel("Background",
             img(src = "Bob_Ross_2.jpg"),
              br(),
              br(),
              p(h3(strong("Bob Ross")), "was a painter who hosted step-by-step lessons via television show in the 80’s and 90’s; 
              ...
              br(),
              p("Though Ross is kept alive through his over 400 episodes available online -- the younger generation 
